...
def main():
    ...
    st.markdown("""
- **Model Training Data**: WRDS Compustat (Jan 2015 – Dec 2024) containing 26K rows and using fundamental metrics like current assets, net income, liabilities, etc. and technical metrics like return, volume, and volatility. 
...
- **Rating**:
    - We used MinMax Scaler to scale our fundamental and technical scores into two seperate ratings ranging from 1-10.
    - The ratings are then averaged out (based on the user's fundamental and technical weightage) to return the final score 
    """)
